...
const reasons = [
  ...
  {
    icon: Video,
    text: 'Capture early footage from a gothic soulslike FPS before the wider Steam audience sees it.',
  },
  {
    icon: UserRound,
  ...
  return (
    <main className="relative z-10 pt-28">
      ...
      <InfoSection
        ...
        text="Closed Beta is especially useful for creators who want early footage from a gothic soulslike FPS. Clips, streams, shorts, reactions, and videos from beta players may be featured across YouTube, TikTok, and Instagram."
      />
      <InfoSection
        eyebrow="Development"
